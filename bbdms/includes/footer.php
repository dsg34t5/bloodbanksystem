      ...
      <div class="container py-xl-5 py-lg-3">
        <div class="row">
          <div class="col-md-4 w3l-footer">
            ...
            <p>The Blood Bank Management System developed by GITAM University, Bengaluru, is a comprehensive software solution designed to streamline and manage the critical functions of a blood bank. This system facilitates efficient donor registration, blood inventory management, and seamless communication between donors, recipients, and healthcare providers</p>
          </div>
...
{ ?>
        ...
        <div class="border-top mt-5 pt-lg-4 pt-3 pb-lg-0 pb-3 text-center">
          <p class="copy-right-grids mt-lg-1">©  Blood Bank Donor Management System GITAM@2024
