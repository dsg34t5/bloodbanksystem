                ...
                <div class="row">
                    <div class="col-lg-7 top-social-agile">
                        <div class="row">
                            ...
                            <li class="ml-3">
                                <a href="https://www.facebook.com/GITAMUniversity/" target="_blank">
                                    <i class="fab fa-facebook-f"></i>
                                </a>
                            </li>
                                <a href="https://twitter.com/GITAMUniversity" target="_blank">
                                    <i class="fab fa-twitter"></i>
                                </a>
                            </li class="ml-3">
                            <li>
                                <a href="https://scholar.google.com/citations?user=GitamUniversityProfile" target="_blank">
